...
.detail_container .detail_info {position: relative;flex:2;margin-right:3.125rem;width:100%;z-index:1}
.detail_container .detail_info h1 {margin-top:3.125rem;font-size:3.25rem}
