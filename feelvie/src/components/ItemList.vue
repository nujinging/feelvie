...
@media (max-width: 767px) {
  .item_container {padding:1.25rem}
  .swiper+.title {margin-top:1.325rem}
  .swiper-slide {width: 120px}.item_card img {width: 120px;height: 180px}
  .item_card h3 {font-size:16px}
}
</style>