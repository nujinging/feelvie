...
.search_container .search_input .search_txt {color:#eee;font-size:28px;border:none;background:none}
.search_container .search_input .icon_search {position:absolute;right:0;bottom:0;width:50px;height:50px;background:#fff}
</style>